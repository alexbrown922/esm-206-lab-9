...
# Note: This is bad (b/c price per sqft is calculated from the dependent variable price --- biased overfitting of model results)
...
# Overall, heteroscedasticity is OK, residuals normality definitely looks good, and conceptually and mathematically my model makes sense!
```
...
# I would still pick homes_lm3 b/c of all of these things: Overall, heteroscedasticity is OK, residuals normality definitely looks good, and conceptually and mathematically my model makes sense!
```
